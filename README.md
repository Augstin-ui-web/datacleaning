🚨 Phishing URL Detection using Machine Learning (A Machine Learning model to classify URLs as Good or Bad using TF-IDF and Naive Bayes.)
...
(A bar plot shows distribution of good vs bad URLs. This helps identify dataset balance.)

Data Preprocessing
(Split data into training and testing sets (80/20). Transform URL strings into numerical vectors using TF-IDF.0
